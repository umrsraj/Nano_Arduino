...
// http://projectsiot.xyz/IoTProjects/SmartStreet/upload.php?a=N&b=N&c=N&d=N
//http://projectsiot.xyz/IoTProjects/SmartStreet/view.php
#include "WiFiEsp.h"
#include<String.h>
...
int ldr = 0, ldr1 = 0, ldr2 = 0,ldr3 = 0;
char light_status = '\0',light1_status = '\0',light2_status = '\0',light3_status = '\0';
...
String A = "GET /IoTProjects/SmartStreet/upload.php?a=";
String Z = " HTTP/1.1";
...
Serial.print(F("ldr3 = ")); Serial.println(ldr3);
delay(1000);
...
{  
 ...
 iot = A + light_status + "&b=" + light1_status + "&c=" + light2_status+ "&d=" + light3_status + Z;
